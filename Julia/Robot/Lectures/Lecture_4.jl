...
Подход к программированию (парадигда программирования), согласно которому описание данных и алгоритмов (функций)
...
Иногда, правда второй случай более предпочтителен в виду того, что в проивном случае ошибка при попытке 
