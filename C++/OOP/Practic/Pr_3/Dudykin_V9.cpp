...
class B1: virtual public A1
{
    protected:
        int b1;
    public:
        B1(int V1 = 0, int V2 = 0) : A1(V2) { b1 = V1; std::cout << "\nClass B1 constructor"; }
...
class B2 : virtual public A1
{
    protected:
        int b2;
    public:
        B2(int V1 = 0, int V2 = 0) : A1(V2) { b2 = V1; std::cout << "\nClass B2 constructor"; }
...
class B3 : virtual public A1
{
    protected:
        int b3;
    public:
        B3(int V1 = 0, int V2 = 0) : A1(V2) { b3 = V1; std::cout << "\nClass B3 constructor"; }
...
class C1 : virtual public B1, virtual public B2, virtual public B3
{
    protected:
        int c1;
    public:
        C1(int V1 = 0, int V2 = 0, int V3 = 0, int V4 = 0) : B1(V2), B2(V3), B3(V4) { c1 = V1; std::cout << "\nClass C1 constructor"; }
...
class C2 : virtual public B1, virtual public B2, virtual public B3
{
    protected:
        int c2;
    public:
        C2(int V1 = 0, int V2 = 0, int V3 = 0, int V4 = 0) : B1(V2), B2(V3), B3(V4) { c2 = V1; std::cout << "\nClass C2 constructor"; }
