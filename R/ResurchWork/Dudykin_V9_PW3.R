...
#лучшая модель среди ВСЕХ степеней - это model4(два регрессора возводятся в степень 0.1):
...
vif(model_subset1)
#R^2 = 21.29%, незначительны переменные dangerous, government, log(age); vif нормален (до 3.5)
#среди городских жителей не состоящие в браке всё те же индивиды получают зарплату больше других, в этом подмножестве
#наличие высшего образование играет ещё более важную роль(коэффициент равен 0.67)

#подмножество разведённых людей без высшего образования
...
vif(model_subset2)
#R^2 = 14.43% - очень маленький, все переменные, кроме government незначительны(у government 1 "звёздочка"),
#vif нормален (до 3.7). У разведенных женщин с высшем образованием работа скорее всего предусматривает что-то простое, без
#возможности карьерного роста, поэтому нет зависимости ни от каких переменных, работать может каждый в таких профессиях
